...
#define START_MASTERNODE_PAYMENTS_TESTNET 1435276740 
#define START_MASTERNODE_PAYMENTS 1435276740 

static const int64_t DARKSEND_COLLATERAL = (200*COIN);
static const int64_t DARKSEND_FEE = (0.999*COIN);
static const int64_t DARKSEND_POOL_MAX = (199.99*COIN);
