...
bool CWalletDB::WritecovenNodeConfig(std::string sAlias, const CcovenNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("coven"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadcovenNodeConfig(std::string sAlias, CcovenNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("coven"), sAlias), nodeConfig);
}

bool CWalletDB::ErasecovenNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
    return Erase(std::make_pair(std::string("coven"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "coven")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CcovenNodeConfig covenNodeConfig;
	    ssValue >> covenNodeConfig;
	    pwallet->mapMycovenNodes.insert(make_pair(sAlias, covenNodeConfig));
	}
    } catch (...)
    {
        return false;
