...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 200 COVEN at the same time
};
...
public:
    ...
    std::map<std::string, CcovenNodeConfig> mapMycovenNodes;
    bool AddcovenNodeConfig(CcovenNodeConfig nodeConfig);
