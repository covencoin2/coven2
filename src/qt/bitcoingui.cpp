    ...
    nWeight(0)
{
...
#endif
    setObjectName("coven");
    setStyleSheet("#coven { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #e8e8e8, stop: 1 #e8e8e8);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-image:url(:images/tbg);  }");
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/node"), tr("&coven Node"), this);
    masternodeManagerAction->setToolTip(tr("Show coven Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    richListPageAction = new QAction(QIcon(":/icons/rlist"), tr("&Rich List"), this);
    richListPageAction->setToolTip(tr("Show top coven balances."));
    ...
    aboutAction = new QAction(tr("&About coven"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; }  } #tabs { color: #ffffff; background-image:url(:images/tbg); }");
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-coven network", "", count));
}
#endif
