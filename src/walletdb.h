...
public:
    ...
    bool WritecovenNodeConfig(std::string sAlias, const CcovenNodeConfig& nodeConfig);
    bool ReadcovenNodeConfig(std::string sAlias, CcovenNodeConfig& nodeConfig);
    bool ErasecovenNodeConfig(std::string sAlias);
